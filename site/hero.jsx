...
function Hero() {
  ...
  return (
    <section id="top" style={{ position: 'relative', paddingTop: isMobile ? 40 : 60, paddingBottom: isMobile ? 56 : 80, borderBottom: `1.5px solid ${window.CL.ink}` }} className="cl-page-grid">
      <div style={{ maxWidth: window.CL.maxw, margin: '0 auto', padding: isMobile ? '0 20px' : '0 32px' }}>

        {!isMobile && (
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', paddingBottom: 18, borderBottom: `1px solid ${window.CL.rule}`, marginBottom: 0 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1.5fr 1fr', gap: isMobile ? 36 : 48, alignItems: 'flex-start', paddingTop: isMobile ? 0 : 56, paddingBottom: 32 }}>
          <div>
            ...
            <h1 style={{
              ...
              fontSize: isMobile ? 'clamp(48px, 13vw, 80px)' : 'clamp(54px, 7.2vw, 116px)',
              ...
              <span style={{ color: window.CL.signal, position: 'relative' }}>
                <SlotWord
                  ...
                  weight={500}
                  size={isMobile ? Math.min(80, Math.max(48, window.innerWidth * 0.13)) : Math.min(116, Math.max(54, window.innerWidth * 0.072))}
                  italic={true}
                />
              </span>
              <br />
            ...
            <div style={{ marginTop: isMobile ? 28 : 40, maxWidth: 560 }}>
              ...
              <p style={{ fontFamily: window.CL.serif, fontSize: isMobile ? 17 : 19, lineHeight: 1.55, color: window.CL.ink, margin: 0, fontWeight: 400 }}>
              ...
              <div style={{ display: 'flex', gap: 12, marginTop: isMobile ? 20 : 28, flexWrap: 'wrap' }}>
                <a href="Programs.html" style={{ display: 'inline-flex', alignItems: 'center', gap: 10, padding: '13px 20px', border: `1.5px solid ${window.CL.ink}`, background: window.CL.ink, color: window.CL.paper, fontFamily: window.CL.mono, fontSize: 11, letterSpacing: '.2em', textTransform: 'uppercase' }}>
